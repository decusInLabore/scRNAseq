...
for (i in 1:length(cellTypeIDs)){
  ...
  if (!is.null(Obio@parameterList$reportTableDir) & dir.exists(Obio@parameterList$reportTableDir)){
      tabBaseFN <- paste0(
      ...
      sheetName <- substr(paste0("Cell_numbers_", Obio@parameterList$project_id),1,30)
      ...
      writeData(wb, 1, dfResTemp, startRow = 1, startCol = 1, headerStyle = hs1)
