...
projectID <- Obio@parameterList$project_id
...
## Organise sampleNames for the figure legends
OsC@meta.data <- OsC@meta.data[order(OsC@meta.data$sampleName, decreasing=T), ]
