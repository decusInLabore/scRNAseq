...
Obio = new(
    ...
    parameterList = list(
       ...
       "lims.id"= as.vector(dfObio$asf.id[1]),
        ...
        "loadR" = "module purge;source /nemo/stp/babs/working/software/modulepath_new_software_tree_2018-08-13;module load pandoc/2.2.3.2-foss-2016b;ml R/3.6.0-foss-2016b-BABS;R;",
