...
ObioFN <- list.files()[grep(".bioLOGIC.Robj", list.files())]
...
## Load Seurat object
SeuratFN <- list.files()[grep(".Seurat.Robj", list.files(Obio@parameterList$localWorkDir))]
load(SeuratFN)
...
dfMeta[dfMeta[,Obio@parameterList$singleCellClusterString] %in% c(2,4,5,13,14), "subclustering"] <- "Subcluster Selection"

dfMeta[!(dfMeta[,Obio@parameterList$singleCellClusterString] %in% c(2,4,5,13,14)), "subclustering"] <- "Rest"
...
clusterTag <- "sub_clusters_ExNeurons"
...
dfData <- import.db.table.from.db(
    ...
    dbname =  Obio@parameterList$primDataDB,
