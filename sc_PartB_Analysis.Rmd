...
```{r child = 'src/modules/section_B/B.3.create.integrated.seurat.object.Rmd', eval=FALSE}
```
...
```{r child = 'src/modules/section_B/B.4.create.variation.plots.Rmd', eval=FALSE}
```

<!-- Essential 6: (output required later): 
DGE Marker gene upload Chapter/Module -->
```{r child = 'src/modules/section_B/B.6.create.pca.plots.Rmd', eval=FALSE}
```
