...
setGeneric(
  ...
  def=function(
    ...
    ## Shorten to maxlength of 64
    names(comp_1) <- substr(names(comp_1), 1, 64)
...
DGEinputList <- list(
  "comp_1" = list(
      "name"    = "DGE_M1M2M3_vs_T1ET1ET4",
      "DGEselCol" = "subClusterName",
      "DGEsampleList" = list(
          "M1M2M3"   = c("M1", "M2", "M3"),
          "T1ET1ET4" = c("T1", "ET1", "ET4")
      )
  ),
  "comp_2" = list(
      "name"    = "DGE_M1M2M3_vs_T1",
      "DGEselCol" = "subClusterName",
      "DGEsampleList" = list(
          "M1M2M3"   = c("M1", "M2", "M3"),
          "T1" = c("T1")
...
for (i in 1:length(DGEinputList)){
    DGEinputList[[i]]$name <- substr(DGEinputList[[i]]$name, 1, 64)
}
...
for (i in 1:length(DGEtagVec)){
    ...
    plotList[[tag]] <- ggplot(
      ...
      ) + scale_y_continuous(breaks=c(seq(0,400, yInc))
