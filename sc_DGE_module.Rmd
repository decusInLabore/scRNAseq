...
DGEinputList <- list(
  "comp_1" = list(
      "name"    = "DGE_MatB52_vs_Control",
      "DGEselCol" = "meta_Treatment",
      "DGEsampleList" = list(
          "MatB52"   = c("MatB52"),
          "Control" = c("Control")
      )
  ...
  "comp_2" = list(
      "name"    = "DGE_Regeneron_vs_Control",
      "DGEselCol" = "meta_Treatment",
      "DGEsampleList" = list(
          "Regeneron"   = c("Regeneron"),
          "Control" = c("Control")
      )
  ),
  "comp_3" = list(
      "name"    = "DGE_Regeneron_vs_MatB52",
      "DGEselCol" = "meta_Treatment",
      "DGEsampleList" = list(
          "Regeneron"   = c("Regeneron"),
          "Control" = c("MatB52")
...
############
## Add to main dbTable
database.table <- biologicSeqTools::import.db.table.from.db(
...
cmd.vec <- upload.datatable.to.database(
    ...
    db.col.parameter.list = biologicSeqTools::inferDBcategories(Obio@databaseTable),
    new.table = TRUE,
...
color.sel = scales::hue_pal()(length(color.groups))
...
biologicSeqTools::createSettingsFile(
    obj = Obio,
