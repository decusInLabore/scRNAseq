...
DGEinputList <- list(
  "comp_1" = list(
      "name"    = "DGE_Neuron_vs_Glia",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Neuron1"   = c(0,1,3,4,5,6,7,10),
          "Glia1" = c(2)
      )
  ),
  "comp_2" = list(
      "name"    = "DGE_NeuronsChAT_vs_NeuronsOther",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsChAT2" = c(0,3,6,7),
          "NeuronsOther2"   = c(1,4,5,10)
      )
  ),
  "comp_3" = list(
      "name"    = "DGE_Neurons_Nos_vs_Neurons_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsNos3"   = c(1,5,10),
          "NeuronsOther3" = c(0,3,4,6,7)
      )
  ),
  "comp_4" = list(
      "name"    = "DGE_Neurons_5HT_vs_Neurons_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Neurons5HT4"   = c(4),
          "NeuronsOther4" = c(0,1,3,5,6,7,10)
      )
  ),
  "comp_5" = list(
      "name"    = "DGE_Neurons_Chat1_vs_Neurons_ChAT_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsChat15"   = c(0),
          "NeuronsChatOther5" = c(3,6,7)
      )
  ),
  "comp_6" = list(
      "name"    = "DGE_NeuronChat2_vs_Neuron_ChAT_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronChat26"   = c(3),
          "NeuronChatOther6" = c(0,6,7)
      )
  ),
  "comp_7" = list(
      "name"    = "DGE_NeuronChat3_vs_Neuron_ChAT_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronChat37"   = c(6),
          "NeuronChatOther7" = c(0,3,7)
      )
  ),
  "comp_8" = list(
      "name"    = "DGE_NeuronNos1_vs_Neuron_Nos_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronNos18"   = c(1),
          "NeuronNosOther8" = c(5,10)
      )
  ),
  "comp_9" = list(
      "name"    = "DGE_NeuronNos2_vs_Neuron_Nos_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronNos29"   = c(5),
          "NeuronNosOther9" = c(1,10)
      )
  ),
  "comp_10" = list(
      "name"    = "DGE_NeuronNos3_vs_Neuron_Nos_Other",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronNos310"   = c(10),
          "NeuronNosOther10" = c(1,5)
      )
  ),
  "comp_11" = list(
      "name"    = "DGE_NeuronsNOSChat_vs_ChatOther",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsNOSChat11"   = c(7),
          "NeuronChatOther11" = c(0,3,6)
      )
  ),
  "comp_12" = list(
      "name"    = "DGE_NeuronsNOSChat_vs_NeuronsNosOthers",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NeuronsNOSChat12"   = c(7),
          "NeuronsNosOther12" = c(1,5,10)
      )
  ),
  "comp_13" = list(
      "name"    = "DGE_Neurons5HT_vs_NeuronsNos",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Neurons5HT13"   = c(4),
          "NeuronsNos13" = c(1,5,10)
      )
  ),
  "comp_14" = list(
      "name"    = "DGE_Neurons5HT_vs_NeuronsChat",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Neurons5HT14"   = c(4),
          "NeuronsChat14" = c(0,3,6,7)
      )
  ),
  "comp_15" = list(
      "name"    = "DGE_Chat1_vs_OtherUMAPChAT",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Chat115"   = c(0),
         "OtherUMAPChAT15" = c(3,6)
      )
  ),
  "comp_16" = list(
      "name"    = "DGE_Chat2_vs_OtherUMAPChAT",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Chat216"   = c(3),
          "OtherUMAPChAT16" = c(0,6)
      )
  ),
  "comp_17" = list(
      "name"    = "DGE_Chat3_vs_OtherUMAPChAT",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Chat317"   = c(6),
          "OtherUMAPChAT17" = c(0,3)
      )
  ),
  "comp_18" = list(
      "name"    = "DGE_NOS1_vs_OtherUMAPNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NOS118"   = c(1),
          "OtherUMAPNOS18" = c(5,7,10)
      )
  ),
  "comp_19" = list(
      "name"    = "DGE_NOS2_vs_OtherUMAPNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NOS219"   = c(5),
          "OtherUMAPNOS19" = c(1,7,10)
      )
  ),
  "comp_20" = list(
      "name"    = "DGE_NOS3_vs_OtherUMAPNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "NOS320"   = c(10),
          "OtherUMAPNOS20" = c(1,5,7)
      )
  ),
  "comp_21" = list(
      "name"    = "DGE_C5HT_vs_UMAPNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "C5HT21"   = c(4),
          "UMAPNOS21" = c(1,5,7,10)
      )
  ),
  "comp_22" = list(
      "name"    = "DGE_C5HT_vs_UMAPChAT",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "C5HT22"   = c(4),
          "UMAPChAT22" = c(0,3,6)
  ...
  "comp_25" = list(
      "name"    = "DGE_Other1_vs_ NeuronsNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Other25"   = c(8),
           "NeuronsNos25"   = c(1,5,10)
      )
 ),
  "comp_26" = list(
      "name"    = "DGE_Other1_vs_ UMAPNOS",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Other26"   = c(8),
           "UMAPNOS26"   = c(1,5,7,10)
      )
 ),
  "comp_27" = list(
      "name"    = "DGE_Other1_vs_Neurons5HT",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Other127"   = c(8),
          "Neurons5HT27"   = c(4)
  ...
  "comp_29" = list(
      "name"    = "DGE_Other1_vs_Neuron",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Other129"   = c(8),
          "Neuron29"   = c(0,1,3,4,5,6,7,10)
      )
 ),
  "comp_30" = list(
      "name"    = "DGE_Other1_vs_Chat3",
      "DGEselCol" = "seurat_clusters",
      "DGEsampleList" = list(
          "Other130"   = c(8),
          "Chat330"   = c(6)
...
for (i in 1:length(DGEinputList)){
    ...
    ## Add cluster colors ##
    dfPlot[["Cluster"]] <- dfPlot[,unlist(DGEinputList[[i]]["name"])]
