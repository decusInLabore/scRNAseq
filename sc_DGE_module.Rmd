...
DGEinputList <- list(
  "comp_1" = list(
      "name"    = "DGE_T_Regeneron_vs_T_Ctrl",
      "DGEselCol" = "sampleID",
      "DGEsampleList" = list(
          "T_Regeneron"   = c("Regeneron_R1","Regeneron_2","Regeneron_3"),
          "T_Ctrl"   = c("Control_R1","Control_R2","Control_R3")
      )
  ),
  "comp_2" = list(
      "name"    = "DGE_T_MatB52_vs_T_Ctrl",
      "DGEselCol" = "sampleID",
      "DGEsampleList" = list(
          "T_MatB52"   = c("MatB52_R1","MatB52_R2" ,"MatB52_R3"),
          "T_Ctrl"   = c("Control_R1","Control_R2","Control_R3")
      )
  ),
  "comp_3" = list(
      "name"    = "DGE_T_Regeneron_vs_T_MatB52",
      "DGEselCol" = "sampleID",
      "DGEsampleList" = list(
          "T_Regeneron"   = c("Regeneron_R1","Regeneron_2","Regeneron_3"),
          "T_MatB52"   = c("MatB52_R1","MatB52_R2" ,"MatB52_R3")
