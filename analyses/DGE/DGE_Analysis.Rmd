...
### DGE Instructions 
Make all old vs. young binary comparisons
...
# OsC@meta.data[["seurat_clusters_state"]] <- paste0(
#     "C",
#     OsC@meta.data$seurat_clusters,
#     "_",
#     OsC@meta.data$meta_State
# )
# 
# 
# 
# dfTemp <- unique(OsC@meta.data[,c("clusterName", "seurat_clusters", "seurat_clusters_state", "meta_State")])
# dfTemp <- dfTemp[order(dfTemp$seurat_clusters),]
# 
# comparisonCol <- "seurat_clusters"
# groupCol <- "seurat_clusters_state"
# 
...
#     
#     if (nrow(dfTemp2) == 2){
#       groupA <- dfTemp2[1, groupCol ]
#       groupB <- dfTemp2[2, groupCol ]
...
OsC@meta.data[["samplegroup_seurat_clusters"]] <- paste0(
    ...
    "_C",
    OsC@meta.data$integrated_snn_res.0.2
)
...
DGEinputList <- list(
  "comp_1" = list(
      "name"    = "DGE_Astro_A_C1_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Astro_A_C1_Old"   = c("Old_C1"),
          "Astro_A_C1_Young"   = c("Young_C1")
      )
  ),
  "comp_2" = list(
      "name"    = "DGE_Astro_B_C2_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Astro_B_C2_Old"   = c("Old_C2"),
          "Astro_B_C2_Young"   = c("Young_C2")
      )
  ),
  "comp_3" = list(
      "name"    = "DGE_Astro_C_C6_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Astro_C_C6_Old"   = c("Old_C6"),
          "Astro_C_C6_Young"   = c("Young_C6")
      )
  ),
  "comp_4" = list(
      "name"    = "DGE_Astro_D_C10_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Astro_D_C10_Old"   = c("Old_C10"),
          "Astro_D_C10_Young"   = c("Young_C10")
      )
  ),
  "comp_5" = list(
      "name"    = "DGE_OPC_A_C3_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "OPC_A_C3_Old"   = c("Old_C3"),
          "OPC_A_C3_Young"   = c("Young_C3")
      )
  ),
  "comp_6" = list(
      "name"    = "DGE_OPC_B_C16_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "OPC_B_C16_Old"   = c("Old_C16"),
          "OPC_B_C16_Young"   = c("Young_C16")
      )
  ),
  "comp_7" = list(
      "name"    = "DGE_OPC_C_C19_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "OPC_C_C19_Old"   = c("Old_C19"),
          "OPC_C_C19_Young"   = c("Young_C19")
      )
  ),
  "comp_8" = list(
      "name"    = "DGE_Oligo_A_C0_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Oligo_A_C0_Old"   = c("Old_C0"),
          "Oligo_A_C0_Young"   = c("Young_C0")
      )
  ),
  "comp_9" = list(
      "name"    = "DGE_Oligo_B_C4_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Oligo_B_C4_Old"   = c("Old_C4"),
          "Oligo_B_C4_Young"   = c("Young_C4")
      )
  ),
  "comp_10" = list(
      "name"    = "DGE_Oligo_C_C18_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Oligo_C_C18_Old"   = c("Old_C18"),
          "Oligo_C_C18_Young"   = c("Young_C18")
      )
  ),
  "comp_11" = list(
      "name"    = "DGE_Mglia_A_C5_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Mglia_A_C5_Old"   = c("Old_C5"),
          "Mglia_A_C5_Young"   = c("Young_C5")
      )
  ),
  "comp_12" = list(
      "name"    = "DGE_Mglia_B_C13_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Mglia_B_C13_Old"   = c("Old_C13"),
          "Mglia_B_C13_Young"   = c("Young_C13")
      )
  ),
  "comp_13" = list(
      "name"    = "DGE_Ex_A_C8_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Ex_A_C8_Old"   = c("Old_C8"),
          "Ex_A_C8_Young"   = c("Young_C8")
      )
  ),
  "comp_14" = list(
      "name"    = "DGE_Ex_B_C9_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Ex_B_C9_Old"   = c("Old_C9"),
          "Ex_B_C9_Young"   = c("Young_C9")
      )
  ),
  "comp_15" = list(
      "name"    = "DGE_Ex_C_C11_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Ex_C_C11_Old"   = c("Old_C11"),
          "Ex_C_C11_Young"   = c("Young_C11")
      )
  ),
  "comp_16" = list(
      "name"    = "DGE_CRcells_C7_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "CRcells_C7_Old"   = c("Old_C7"),
          "CRcells_C7_Young"   = c("Young_C7")
      )
  ),
  "comp_17" = list(
      "name"    = "DGE_PeriC_C12_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "PeriC_C12_Old"   = c("Old_C12"),
          "PeriC_C12_Young"   = c("Young_C12")
      )
  ),
  "comp_18" = list(
      "name"    = "DGE_Endo_C15_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Endo_C15_Old"   = c("Old_C15"),
          "Endo_C15_Young"   = c("Young_C15")
      )
  ),
  "comp_19" = list(
      "name"    = "DGE_Vacs_C17_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Vacs_C17_Old"   = c("Old_C17"),
          "Vacs_C17_Young"   = c("Young_C17")
      )
  ),
  "comp_20" = list(
      "name"    = "DGE_Tcells_C14_Old_vs_Young",
      "DGEselCol" = "samplegroup_seurat_clusters",
      "DGEsampleList" = list(
          "Tcells_C14_Old"   = c("Old_C14"),
          "Tcells_C14_Young"   = c("Young_C14")
      )
  )
...
for (i in 1:length(DGEinputList)){
    ...
    dfCol[dfCol$name == redGroup, "col"] <- "#48A6EA"
    dfCol[dfCol$name == blueGroup, "col"] <- "#E6C229"
...
for (j in 1:length(DGEtagVec)){
  ...
  if ((length(posTestGeneSet) >= 3) | (length(negTestGeneSet) >= 3)){
    ...
    if ((nrow(dfTempEnriched) > 0) | (nrow(dfTempEnrichedNeg) > 0)){
      ...
      baseFN <- paste0(
        Obio@parameterList$project_id, 
        ".DGE.cat.enrichment.table.",version,".xlsx"
      )
...
for (i in 1: length(DGEtagVec)){
  ...
  selNames <- names(EnrichedGenesList)[grep(hmVec[i] ,names(EnrichedGenesList))]
...
```{r, echo=F, eval=TRUE, warning=FALSE, results=F, error = FALSE} 
