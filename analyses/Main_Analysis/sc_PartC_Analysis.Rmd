...
projectDir <-  "/nemo/stp/babs/working/boeings/Projects/bonfantip/roberta.ragazzini/446B_scRNAseq_subClustering_pbl359B_12clusters/"


workdir <- "/nemo/stp/babs/working/boeings/Projects/bonfantip/roberta.ragazzini/446B_scRNAseq_subClustering_pbl359B_12clusters/workdir/"
...
perc_fun <- function(obj, genes, assay = "RNA") {
  ...
  z[z > 0] <- 1  
  ExprMatrix <- round(( rowSums(data.frame(z)) / ncol(z) ) * 100, 1 )
...
FNcolCustom <- paste0(
    projectDir, 
    "scripts/scRNAseq/design/customClusterAnnotation.txt"
)

FNcol <- paste0(projectDir, "scripts/scRNAseq/design/clusterAnnotation.txt")
