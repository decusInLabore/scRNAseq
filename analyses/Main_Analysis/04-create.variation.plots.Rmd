...
for (i in 1:length(SampleList)){
    ...
    Seurat::Idents(SampleList[[i]]) <- "sampleID"
    cluster.averages <- Seurat::AverageExpression(
        SampleList[[i]], 
        return.seurat = TRUE
    )
