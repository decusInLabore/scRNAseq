...
## Downsample to 70 000 dots 
if (nrow(dfPlot) > 70000){
      set.seed(42)
      dfPlot <- dfPlot[sample(nrow(dfPlot), 70000), ]
}
...
for (i in 1:length(sampleVec)){
    ...
    ## Downsample to 70 000 dots 
    if (nrow(dfPlotSel) > 70000){
          set.seed(42)
          dfPlotSel <- dfPlotSel[sample(nrow(dfPlotSel), 70000), ]
    }           
