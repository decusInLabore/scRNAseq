...
# for (i in 1:length(genotypes)){
    ...
    pos <- grep("^meta_Timepoint$", names(OsC@meta.data))
    
    if (length(pos) == 1){
        selCol <- "meta_Timepoint"
    ...
    selVec <- c("cellID", "clusterName", "clusterColor", selCol)
    ...
    plotList[[tag]] <- ggplot2::ggplot(data, ggplot2::aes(x = timepoint, y = percentage,
        ...
        ggplot2::scale_x_continuous(
            breaks=c(0, 2, 4, 8, 12, 24), 
            labels=c("0", "2", "4", "8", "12", "24")
        )
  ...
  ## Make area plot without time axis
