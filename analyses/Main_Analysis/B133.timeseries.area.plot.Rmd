...
# for (i in 1:length(genotypes)){
    ...
    selVec <- c("cellID", "clusterName", "clusterColor", "meta_Age_Group")
    
    # dfRes <- dfRes[dfRes$meta_Genotype == genotypes[i], selVec]
    dfRes[["timepoint"]] <- dfRes$meta_Age_Group
    dfRes[["timepoint"]] <- gsub("Young", 2.5, dfRes$timepoint)
    dfRes[["timepoint"]] <- gsub("Middle", 7.5, dfRes$timepoint)
    dfRes[["timepoint"]] <- gsub("Old", 20, dfRes$timepoint)
