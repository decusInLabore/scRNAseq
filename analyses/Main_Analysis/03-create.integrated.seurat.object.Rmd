...
###############################################################################
## Add scalde data and pca for rpca integration                              ##
...
if (iMethod == "rpca"){
    ...
    for (i in 1:length(SampleList)){
         SampleList[[i]] <- Seurat::ScaleData(SampleList[[i]], features = features, verbose = FALSE)
         SampleList[[i]] <- Seurat::RunPCA(SampleList[[i]], features = features, verbose = FALSE)
    }
}
