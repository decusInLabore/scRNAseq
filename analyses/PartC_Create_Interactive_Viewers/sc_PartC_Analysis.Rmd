...
addFNvec <- c(
  paste0(Obio@parameterList$workdir, "temp/UMAP.regression.coordinates.txt"),
  paste0(Obio@parameterList$workdir, "temp/ClusterFinder.output.txt"),
  paste0(Obio@parameterList$workdir, "temp/species.inference.txt")
)
