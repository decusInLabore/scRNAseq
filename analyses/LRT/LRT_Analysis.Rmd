...
for (i in 1:length(LRToptions)){
    ...
    name <- paste0("LRT_", as.vector(dfTemp[i, "clusterName"]), "_sampleName")
...
dfAdd <- unique(OsC_HM@meta.data[,c("clusterName", "clusterColor", "sampleName", "sampleColor", selClust)])
...
OsCsel@meta.data <- OsCsel@meta.data[order(OsCsel@meta.data$clusterName,OsCsel@meta.data$sampleName),]
