...
<!-- Optional 5: monocle3 -->
```{r child = '03-monocle.trajectory.module.overview.Rmd', eval=TRUE, results=FALSE, message= FALSE}
```

<!-- Optional 5: monocle3 Branch 1 Subtrajectory -->
<!-- Add as many sub-trajectory analyses as necessary as banch.1, branch.2, branch.3... -->
```{r child = '04-monocle.trajectory.module.branch.1.Rmd', eval=TRUE, results=FALSE, message = FALSE}
```

<!-- Optional 5: monocle3 Branch 1 Subtrajectory -->
<!-- Add as many sub-trajectory analyses as necessary as banch.1, branch.2, branch.3... -->
```{r child = '04-monocle.trajectory.module.branch.2.Rmd', eval=TRUE, results=FALSE, message = FALSE}
```
...
```{r create_report_params, eval=T, results="asis",error = TRUE}
