...
sbatch --time=24:00:00 --wrap "module purge;source /camp/stp/babs/working/software/modulepath_new_software_tree_2018-08-13;module load pandoc/2.2.3.2-foss-2016b;ml R/4.0.3-foss-2020a;Rscript runRmd.r Main_Analysis.Rmd" --job-name=$project --mem=200G -o ../../../../workdir/rB.$project.slurm >> ../commands.txt
cd -
...
sbatch --time=24:00:00 --wrap "module purge;source /camp/stp/babs/working/software/modulepath_new_software_tree_2018-08-13;module load pandoc/2.2.3.2-foss-2016b;ml R/4.0.3-foss-2020a;Rscript runRmd.r Celltype_Assignment.Rmd" --job-name=$project --mem=200G -o ../rCTA.$project.tslurm >> ../commands.txt
cd -
